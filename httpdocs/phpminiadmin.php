...
*/
 ...
 $ACCESS_PWD='fabrizio'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 if($_SERVER['SERVER_NAME'] == 'nycbikeplus.com') {
   $DBDEF=array(
   'user'=>"nycbikep",
   'pwd'=>"",//IcDt36me35
   'db'=>"nycbikeplus",
 ...
 else if($_SERVER['SERVER_NAME'] == 'mibikeplus.com') {
   $DBDEF=array(
   'user'=>"mibikepl",
   'pwd'=>"",//nJ55l*x9
   'db'=>"mibikeplus",
